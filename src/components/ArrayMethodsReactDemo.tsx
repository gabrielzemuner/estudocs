...
export default function ArrayMethodsReactDemo() {
  ...
  return (
    <div className="grid gap-3">
      <p className="m-0 text-[var(--sl-color-gray-2)]">
        Exemplo “mundo real”: calculando arrays e renderizando no JSX.
      </p>

      <div className="grid gap-2 rounded-2xl border border-[var(--sl-color-gray-5)] bg-white/5 p-4">
        ...
        <div className="text-sm">
          ...
          <span className="text-[var(--sl-color-gray-2)]">{sum}</span>
        </div>
      </div>
      ...
      <div className="grid gap-2">
        ...
        <ul className="m-0 list-disc pl-5 text-[var(--sl-color-gray-2)]">
          {filtered.map((n) => (
